...
### [ADR-008: カラーパレット更新（Teal + Gold）](./008-color-palette-teal-gold.md)
**Status**: Accepted
**概要**: ブランディング統一とユーザビリティ向上を目的としたカラーパレットの定義

**主要決定事項**:
- Primary: Teal (#5AB5B2) - プライマリカラー
- Accent: Gold (#D9A62E) - アクセントカラー
- GitHub風ダークモード採用 (#0d1117ベース)
- CSS変数によるテーマ管理
- アクセシビリティとコントラスト比の確保
